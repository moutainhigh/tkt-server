...
import com.mtl.cypw.domain.ticket.dto.FetchItemPaperDTO;
...
@Slf4j
@Component
public class ItemPaperConverter extends DataConverter<OrderItem, FetchItemPaperDTO> {

    @Override
    public FetchItemPaperDTO convert(OrderItem object) {
        FetchItemPaperDTO dto = new FetchItemPaperDTO();
